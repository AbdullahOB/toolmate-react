...
export const Highlight = ({ children, className }: { children: React.ReactNode; className?: string }) => {
  return (
    <motion.span
      ...
      className={cn(
        `relative inline-block rounded-lg bg-clip-text bg-gradient-to-r from-yellow-orange-1 to-yellow-orange-1 px-1 pb-1 dark:from-indigo-500 dark:to-purple-500`,
        className
      )}>
      {children}
    </motion.span>
