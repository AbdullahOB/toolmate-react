...
export const TypewriterEffect = ({
	...
	return (
		<div className={cn('text-base sm:text-xl md:text-3xl lg:text-5xl font-bold text-start:text-center', className)}>
			{renderWords()}
			<motion.span
				initial={{
					opacity: 0,
	...
	return (
		<div className={cn('flex space-x-1 my-2', className)}>
			...
			<motion.span
				...
				className={cn('block rounded-sm w-[4px]  h-4 sm:h-6 xl:h-12 bg-orange', cursorClassName)}></motion.span>
		</div>
	);
};