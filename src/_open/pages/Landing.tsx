        ...
        <div className=''>
               ...
               {!isMobileChatOpened && (
                <div className='text-center mt-36 lg:justify-start justify-center lg:items-start items-center lg:text-left lg:w-2/3 max-w-2/5 place-content-center flex flex-col gap-12'>
                  ...
                  <motion.div
                    ...
                    transition={{ duration: 1.0, ease: [0.4, 0.0, 0.2, 0.5] }}
                    className='space-y-8'>
                    <div>
                      <p className='text-transparent text-center hidden lg:block bg-clip-text bg-gradient-to-r from-black to-black font-[800] text-5xl lg:text-[60px] sm:text-left lg:text-left leading-[4.9rem] tracking-wider'>
                        ...
                        <span>
                          ...
                          <Highlight className='dark:text-white text-transparent'>free</Highlight> and no sign-up needed
                        </span>
                      </p>
                    ...
                    <div className='space-y-2 lg:w-4/5 flex flex-col text-start'>
                      <div className='flex items-center gap-2'>
                        ...
                        <p className='font-semibold text-gray-800 text-lg'>Grab the right gear for the task</p>
                      </div>
                      <div className='flex items-center gap-2'>
                        <div className='bg-orange p-1 rounded-full'>
                          <CheckIcon className='h-4 w-4 text-white' />
                      ...
                      <div className='flex items-center gap-2'>
                        ...
                        <p className='font-semibold text-gray-800 text-lg'>Cut the waste keep the wins</p>
                      </div>
                    </div>
                    <p className='lg:w-2/3 text-center font-medium lg:text-lg text-xl w-full lg:text-left text-gray-500 tracking-tight'>
                      Matey's here to steer you straight. First crack or fiftieth reno, he'll tell you what's worth
                      grabbing, what to skip, and how to see it through properly.
                    </p>
                    ...
                    <div className='relative'>
                      <div
                        ...
                        <ButtonCustom text='Chat with Matey now' isArrow={true} isDark={true} />
                      </div>
                ...
                <div className='flex gap-2 flex-col'>
                  <div className='font-bold text-3xl items-center text-left w-fit flex'>
                    <div className='flex items-center text-left gap-2'>
                      <p className='font-semibold text-left opacity-80 text-slate-500 text-md'>Already helping</p>
                      <motion.div
          ...
          <div className='py-10'>
            <p className='text-3xl md:text-4xl flex flex-col items-center lg:text-6xl text-center my-5 font-bold md:text-center px-4'>
              Got Questions?
              <span className='text-orange text-center'> Matey's Got Answers!</span>
            </p>
            <FaqSection />
          </div>
          )}
